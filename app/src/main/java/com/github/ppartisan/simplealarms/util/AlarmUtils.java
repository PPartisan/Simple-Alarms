...
import static com.github.ppartisan.simplealarms.data.DatabaseHelper.*;
...
public final class AlarmUtils {
    ...
    public static List<Alarm> buildAlarmList(Cursor c) {

        if (c == null) return new ArrayList<>();

        final int size = c.getCount();

        final List<Alarm> alarms = new ArrayList<>(size);
